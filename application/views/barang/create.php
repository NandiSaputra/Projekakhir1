   <div class="mt-3">
    <form action="<?= base_url('barang/simpanbarang') ?>" method="POST">
     <div class="mb-3">
      ...
      <input type="text" name="nama_barang" class="form-control" id="exampleFormControlInput1" placeholder="Nama Sepeda">
     </div>
     <div class="mb-3">
      <label for="exampleFormControlInput1" class="form-label">Harga Sepeda</label>
      <input type="number" name="harga" class="form-control" id="exampleFormControlInput1" placeholder="Harga Sepeda">
     </div>
     <div class="mb-3">
